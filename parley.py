...
def Character:
  ...
  def __init__(name, faction, rank, location_ship_currently_aboard=LOCATION_SAME_AS_FACTION_STARTING_PLACE, hp=100, playable=False, tendency_to_disobey_orders_pct=1, desperation_to_finish_and_get_paid_for_this_job_pct=10, money_gold_coins=0, untreated_treatable_diseases_penalty_to_hp=0):
    self.name = name
...
g_characters = [
  ...
  Character("Henry Hildberger", FRIENDLY_MEDICAL_VESSEL, "Nurse", hp=95, desperation_to_get_paid_for_this_job_pct=0),
  Character("Ignacio Imperator", FRIENDLY_MEDICAL_VESSEL, "Nurse", location_ship_currently_aboard tendency_to_disobey_orders_pct=10, desperation_to_get_paid_for_this_job_pct=25),
  Character("Julie Jameson", FRIENDLY_MEDICAL_VESSEL, "Sailor", desperation_to_get_paid_for_this_job_pct=35),
  Character("Kristina Kybera", FRIENDLY_MEDICAL_VESSEL, "Doctor", tendency_to_disobey_orders_percent=25, desperation_to_get_paid_for_this_job_pct=80),
]
